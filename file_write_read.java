...
public class Main { 
     	public static void main(String[] args) throws IOException{
             FileWriter myFilew = new FileWriter("my_information.txt");			               myFilew.write("My name is Kevin.\n");
		myFilew.write("I am an English teacher.\n");
	     ...
	     FileReader myFiler = new FileReader ("my_information.txt");
            ...
            Scanner scan = new Scanner (myFiler);				            int i = 1;
										           while (scan.hasNextLine()){
								                System.out.println(i + ": " + scan.nextLine());						            i++;																	            }
	 scan.close();							           myFiler.close();
